...
export type Page = "dashboard"|"transactions"|"reports"|"budgets"|"goals"|"tasks"|"crm"|"documents"|"calendar"|"support-vertex"|"settings"|"companies"|"admin-overview"|"admin-users"|"admin-resources"|"admin-keys"|"admin-content"|"admin-notifications"|"support"|"admin-audit"|"admin-security"|"admin-system"|"admin-settings";
