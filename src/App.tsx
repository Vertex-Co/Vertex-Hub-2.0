...
function CompanyGate(){const{profile,loading,companies,reload}=useCompany();if(loading)return <Loading/>;if(!profile?.isAuthorized)return <Activation onActivated={reload}/>;if(profile.onboardingCompleted||companies.length)return <AccountRequirements><FinanceProvider><FinanceApp/></FinanceProvider></AccountRequirements>;return <Activation onActivated={reload}/>}
