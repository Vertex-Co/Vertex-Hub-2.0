...
export type Page = "dashboard"|"transactions"|"reports"|"budgets"|"goals"|"settings"|"plans"|"companies"|"admin-overview"|"admin-users"|"admin-resources"|"admin-content"|"admin-notifications"|"support"|"admin-audit"|"admin-security"|"admin-system"|"admin-settings";
