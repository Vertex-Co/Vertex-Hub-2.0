...
const minimum=readFileSync("supabase/migrations/202608050005_vertex_donate_minimum_one.sql","utf8");
const checks={
 ...
 "Reconciliação e status Pix aprovado":/action === "get"/.test(orders)&&/processed/.test(orders)&&/accredited/.test(orders)&&/approved/.test(webhook),
